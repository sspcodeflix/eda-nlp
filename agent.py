...
from sqlalchemy import create_engine, text, Column, Integer, String, Text, MetaData, Table
...
def create_agent_for_sql(tool_llm_name: str = "gpt-4", agent_llm_name: str = "gpt-4"):
    """
    ...
    message_history = SQLChatMessageHistory(
        ...
        connection_string=os.getenv("DB_URI"), # use this if password need f"mysql://root:{password}@localhost:3306/ecommerce"
...
def create_agent_for_python(agent_llm_name: str = "gpt-4"):
    """
